...
lista_declaraciones:
		lista_declaraciones COMMA declaracion {printf("lista_declaraciones OK\n");}
...
bloque: bloque sentencia {printf("bloque OK\n");};

bloque: sentencia {printf("bloque OK\n");};

sentencia:
		expresion SCOLON	{printf("sentencia OK\n");}
	|	asignacion SCOLON	{printf("sentencia OK\n");}
	|	asignacion_multiple SCOLON {printf("sentencia OK\n");}
	|	impresion SCOLON {printf("sentencia OK\n");}
	|	lectura SCOLON {printf("sentencia OK\n");}
	;
